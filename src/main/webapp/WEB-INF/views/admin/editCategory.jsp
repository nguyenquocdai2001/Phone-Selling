											...
											<div class="row">
												<div class="col-md-12">
													<div class="form-group">
														...
														name="description"placeholder="Here can be your description" >${category.description}</textarea>
													</div>
												</div>
											</div>
											<div class="row">
												<div class="col-md-4 pr-1">
													...
													value="${category.status}"	name="status"class="form-control" placeholder="1 or 0" >
													</div>
												</div>
												<div class="col-md-4 px-1">
													<div class="form-group">
														<label>Image</label> <input type="text"
													value="${category.image}"name="image"class="form-control" placeholder="Image name">
													</div>
												</div>
