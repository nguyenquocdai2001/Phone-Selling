	...
	<%@ include file="/common/public/info/headerinfo.jsp"%>
			...
			<div class="container" style="margin-top: 30px; margin-bottom: 30px;">
				<div class="row bg-light"
					style="border: 1px darkgrey solid; border-radius: 10px; width: 50%; margin: 0 auto; padding-right:45px;">
					<div class="col-sm-12">
						<header class="text-center py-3 rounded ">
							<h1 class="display-5 font-weight-bold text-secondary text-center">Profile</h1>
						</header>
						<form action="${pageContext.request.contextPath}/editProfileUser" method="POST">
							...
							<div class="form-group">
								...
								<a class="btn btn-secondary" href="${pageContext.request.contextPath}/clienthome">Back</a>
							</div>
						</form>
					</div>
				</div>
