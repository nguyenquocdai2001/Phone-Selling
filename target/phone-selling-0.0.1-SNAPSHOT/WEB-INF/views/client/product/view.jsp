					...
					<div class="row">
						...
						<div class="col-md-7">
							...
							<div class="row mt-2">
								...
								<c:choose>
								<c:when test="${product.quantity > 0}">
									<a class="btn btn-dark  me-3 float-start" href="checkout.html">Add
										to cart<i class="fa fa-shopping-cart"></i>
									</a> &nbsp; &nbsp; 
								</c:when>							
							</c:choose>
									<a class="btn btn-light me-3 float-start"
										href="">Add to wishlist <i class="fa fa-heart"></i></a>
								</div>
							</div>
						</div>
	...
	<c:choose>
		<c:when test="${userSession.id != null}">
			<button type="button" class="btn btn-link" data-bs-toggle="modal"
				data-bs-target="#exampleModal">Rating product</button>
		</c:when>
	</c:choose>
